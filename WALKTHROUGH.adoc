...
Load ALEC with the deep learning engine:

```
feature:repo-add mvn:org.opennms.alec/alaec-karaf-features/1.0.0-SNAPSHOT/xml
feature:install alec-opennms-standalone alec-engine-deeplearning
```
