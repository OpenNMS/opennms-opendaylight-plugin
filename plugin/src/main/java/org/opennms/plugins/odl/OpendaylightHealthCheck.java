...
public class OpendaylightHealthCheck implements HealthCheck {
    ...
    public OpendaylightHealthCheck(OpendaylightRestconfClient restconfClient) {
        this.restconfClient = Objects.requireNonNull(restconfClient);
    }
    ...
    public Response perform(Context context) {
        // Attempt to retrieve the current operational topology
        try {
