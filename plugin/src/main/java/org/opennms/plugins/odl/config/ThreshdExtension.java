...
package org.opennms.plugins.odl.config;
...
public class ThreshdExtension implements ThreshdConfigurationExtension {
    private final ClasspathThreshdConfigurationLoader classpathThreshdConfigurationLoader =
            new ClasspathThreshdConfigurationLoader(ThreshdExtension.class, "threshd-configuration.xml");
