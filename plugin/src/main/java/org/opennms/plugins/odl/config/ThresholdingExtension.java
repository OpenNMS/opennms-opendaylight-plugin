...
public class ThresholdingExtension implements ThresholdingConfigExtension {
    private final ClasspathThresholdingConfigLoader classpathThresholdingConfigLoader =
            new ClasspathThresholdingConfigLoader(ThresholdingExtension.class, "thresholds.xml");
